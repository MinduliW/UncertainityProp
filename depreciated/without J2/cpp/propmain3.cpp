...
class MexFunction : public matlab::mex::Function {
    ...
    void operator()(ArgumentList outputs, ArgumentList inputs) override {
        ...
        //propagate
        fx = RK78(6, mee2eci(Geqoesc,cst[5]), 0.0, tf, cst,DynamicsCart);
        fx = eci2mee(fx, cst[5]);
        ...
        // CEQoe
        x0t     = RV2CEq(x0, cst);
       // cout << x0t.linear() << endl;
        Geqoesc = convertU(tf, x0t);

        //propagate
        fx = RK78(6, CEq2RV(Geqoesc,cst), 0.0, tf, cst,DynamicsCart);
        fx = RV2CEq(fx, cst);
        ...
        fx = RK78(6, GEq2RV(Geqoesc,cst), 0.0, tf, cst,DynamicsCart);
        fx = RV2GEq(fx, cst);
